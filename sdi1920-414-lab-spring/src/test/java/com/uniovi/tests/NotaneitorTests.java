...
public class NotaneitorTests {
	...
	public void PR14() {
		...
		PO_PrivateView.buscarXPath(driver,  "//li[contains(@id, 'marks-menu')]/a", 0);
		PO_PrivateView.buscarXPath(driver,  "//a[contains(@href, 'mark/add')]", 0);

		PO_PrivateView.fillFormAddMark(driver, 3, "Nota Nueva 1", "8");
		PO_PrivateView.buscarXPath(driver,  "//a[contains(@class, 'page-link')]", 3);
	...
	public void PR15() {
		...
		PO_PrivateView.buscarXPath(driver,  "//li[contains(@id, 'marks-menu')]/a", 0);
		PO_PrivateView.buscarXPath(driver, "//a[contains(@href, 'mark/list')]", 0);
		PO_PrivateView.buscarXPath(driver, "//a[contains(@class, 'page-link')]", 3);
		PO_PrivateView.buscarXPath(driver, "//td[contains(text(), 'Nota Nueva 1')]/following-sibling::*/a[contains(@href, 'mark/delete')]", 0);
		PO_PrivateView.buscarXPath(driver, "//a[contains(@class, 'page-link')]", 3);
